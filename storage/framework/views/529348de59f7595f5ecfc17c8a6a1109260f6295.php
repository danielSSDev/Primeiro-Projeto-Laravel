    ...
    <div class="nav-wrapper blue">
        <div class="container">
            ...
            <ul class="right hide-on-med-and-down">
                ...
                <?php else: ?>
                    <li><a class="dropdown-button" href="#!" data-target="dropdown1"><?php echo e(Auth::user()->name); ?><i class="material-icons right">arrow_drop_down</i></a></li>

                    <ul id="dropdown1" class="dropdown-content">
                        <li><a href="#"><?php echo e(Auth::user()->name); ?></a></li>
                        <li><a href="<?php echo e(route('admin.usuarios')); ?>">Usuarios</a></li>
                        <li><a href="<?php echo e(route('admin.paginas')); ?>">Paginas</a></li>
                    </ul>
