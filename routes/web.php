...
Route::post('/admin/login', ['as'=>'admin.logar', 'uses'=>'Admin\UsuarioController@login']);


Route::group(['middleware'=>'auth'], function() {

    Route::get('/admin/login/sair', ['as' => 'admin.logar.sair', 'uses' => 'Admin\UsuarioController@sair']);
